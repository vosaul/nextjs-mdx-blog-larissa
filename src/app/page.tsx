      ...
      <div className="grid gap-9 lg:grid-cols-2">
        ...
        <div className="prose dark:text-slate-100">
          ...
          <ul>
            ...
            <li>Учасниця мистецьких виставок, вітчизняних та закордонних пленерів від 1997. Персональні виставки – в Одесі (2000, 2003–06), Фленсбурзі (Німеччина, 2004), Львові (2008). </li>
          </ul>
